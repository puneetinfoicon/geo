                    ...
                    <div class="col-lg-7 col-lg-custom-6">
                        <div class="left-section">
                            ...
                            <div class="wapper">
                                <div class="min-scroll position-relative">
                                    ...
                                    if ($pImage->url != '') {
                                        ...
                                        $url = url('/public/assets/img/no-image.png');
                                    }
                                    ?>
                                            ...
                                            <div class="update-input">
                                                ...
                                                <div class="price">
                                                    <p><span id="perPrice5128-22-GM"
                                                             class="itemPrice"><?= str_replace(",",".",number_format($cartPrice[$cartData->productNumber]->unitPrice))?></span>
                                                        kr. ekskl. moms </p>
                                                </div>
                                                <?php }else{?>
                                                <div class="price">
                            ...
                            <div class="total-foot">
                                <h3>Total:</h3>
                                <h3><span id="cartPrice"> </span> ekskl. moms</h3>
                            </div>
                            <?php }?>
                        </div>
                    </div>
