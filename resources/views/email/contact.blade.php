                    ...
                    <td valign="top">
                        <div style="max-width: 600px; margin: 0 auto; padding: 0 12px;">
                            <div class="card" style="background: white; border-radius: 0.5rem; padding: 2rem; margin-bottom: 1rem;">
                                <h2 style="color: #4b6e99; margin: 0 0 12px; line-height: 24px; text-align:center;">Geotem Cart Details</h2>
                                <center> <img src="{{url('assets/img/logo.svg')}}" alt="" height="65px"></center>
								@if($name !='')<p><b>Name</b> - {!! ucwords(strtolower($name)) !!}</p>@endif
								@if($email !='')<p><b>Email-Id</b> - {!! $email !!}</p>@endif
								<p><b>Date</b> - <?= date('Y-m-d')?></p>
                                <p style="text-align:justify"><b>Message</b> - {!! $msg !!}</p>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td valign="top" align="center">
                        <div style="max-width: 600px; margin: 0 auto;">
                            <p class="footer_address" style="margin-top: 16px; font-size: 12px; line-height: 20px;">
                                <a href="{{url('/home')}}" style="font-weight: bold; color: #439fe0;">Geoteam Cart</a> &nbsp;&bull;&nbsp;
                                <br />
                                 Geoteam A/S, Energivej, 34 2750 Ballerup Tlf. +45 7733 2233 CVR 28828633
                            </p>
                        </div>
                    </td>
                </tr>
