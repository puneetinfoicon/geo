    ...
    <main class="page-content">
        ...
        <div class="card">
            <div class="card-header py-3">
                <h6 class="mb-0">Add Search Category</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-lg-4 d-flex">
                        <div class="card border shadow-none w-100">
                            <div class="card-body">
                                <form class="row g-3" action="{{route('submit_search_categories')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-primary">Add Search Category</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    ...
                                                    <a href="{{route('edit_search_categories', $category->id)}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Edit {{$category->name}}" aria-label="Edit">
                                            ...
                                            <div class="modal-dialog modal-confirm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        ...
                                                        <button type="button" class="btn btn-danger" onclick=" window.location.href='{{route('delete_searchCategories', $category->id)}}'">Delete</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
