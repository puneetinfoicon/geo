  ...
  <div class="wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="image-upload" method="post" action="{{route('updateContent')}}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="page" value="{{ $content['page'][0] }}">

                            <div class="form-group">
                                <label>Description</label>
                                <textarea name="content1" rows="30" cols="100" class="form-control tinymce-editor">{{ $content['content1'][0] }}</textarea>
                            </div>
    ...
    <script type="text/javascript">
        ...
        tinymce.init({
            ...
            toolbar: '',
            content_css: '//www.tiny.cloud/css/codepen.min.css,https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css,' + url + 'assets/css/owl.carousel.min.css,https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css,' + url + 'assets/css/custom-select.css,' + url + 'assets/css/style.css,' + url + 'assets/css/ma5-menu.min.css,' + url + 'assets/css/responsive.css',
            setup: function(editor) {

              var scriptLoader = new tinymce.dom.ScriptLoader();
              scriptLoader.add( url + "assets/js/jquery.min.js");
              scriptLoader.add( url + "assets/js/popper.min.js");
              scriptLoader.add( url + "assets/js/bootstrap.min.js");
              scriptLoader.add( url + "assets/js/owl.carousel.min.js");
              scriptLoader.add( url + "assets/js/custom-select.js");
              scriptLoader.add( url + "assets/js/ma5-menu.min.js");
              scriptLoader.add( url + "assets/js/custom.js");
            ...
            //       tinymce.ScriptLoader.load('http://localhost/geoteam_new/assets/js/jquery.min.js');
            //       tinymce.ScriptLoader.load('http://localhost/geoteam_new/assets/js/popper.min.js');
            //       tinymce.ScriptLoader.load('http://localhost/geoteam_new/assets/js/bootstrap.min.js');
            //       tinymce.ScriptLoader.load('http://localhost/geoteam_new/assets/js/owl.carousel.min.js');
            //       tinymce.ScriptLoader.load('http://localhost/geoteam_new/assets/js/custom-select.js');
            //       tinymce.ScriptLoader.load('http://localhost/geoteam_new/assets/js/ma5-menu.min.js');
            //       tinymce.ScriptLoader.load('http://localhost/geoteam_new/assets/js/custom.js');
...
.alert.alert-custom.bg-blue.alert-dismissible.fade.show {
    padding: 10px 0;
    display: flex;
